...
resource "aws_codedeploy_deployment_group" "default" {
  ...
  dynamic "ec2_tag_filter" {
    ...
    content {
      lookup(var.ec2_tag_filter.key, "key", null)
      lookup(var.ec2_tag_filter.type, "type", null)
      lookup(var.ec2_tag_filter.value, "value", null)
    }
  }
  ...
  dynamic "ec2_tag_set" {
    ...
    content {
      dynamic "ec2_tag_filter" {
        ...
        content {
          lookup(var.ec2_tag_set.key, "key", null)
          lookup(var.ec2_tag_set.type, "type", null)
          lookup(var.ec2_tag_set.value, "value", null)
        }
      }
    }
  }
